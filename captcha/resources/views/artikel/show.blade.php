				...
				<div class="card">
					...
					<div class="card-body">
						<div class="form-group row">
 						...
 						<div class="form-group row">
							<label class="col-md-4 col-form-label text-md-right">Isi Id</label>
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label text-md-right">Create_At</label>
							<label class="col-md-8 col-form-label text-md-left">{!! $artikel->create_at !!}</label>
						</div>
						<div class="form-group row">
							<label class="col-md-4 col-form-label text-md-right">Update_At</label>
							<label class="col-md-8 col-form-label text-md-left">{!! $artikel->update_at !!}</label>
						</div>
						<div class="form-group row">
							<label class="col-md-4 col-form-label text-md-right">Kategori_Artikel_Id</label>
